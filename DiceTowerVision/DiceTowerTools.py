...
def get_scores_from_good_keypoints(results, log_level=LOG_LEVEL_FATAL):
    good_match_keypoint_ratio = [r["good_matches"]/min(r["template_keypoints"],r["sample_keypoints"]) for r in results] 
...
def get_scores_from_used_keypoints(results, log_level=LOG_LEVEL_FATAL):
    used_match_keypoint_ratio = [r["used_matches"]/min(r["template_keypoints"],r["sample_keypoints"]) for r in results] 
